...
class HttpClient:
    def __init__(self, client_configuration: ClientConfiguration):
        self.client_configuration: ClientConfiguration = client_configuration
        self.__session: aiohttp.ClientSession = aiohttp.ClientSession(
            timeout=aiohttp.ClientTimeout(
                connect=self.client_configuration.timeout_seconds,
                sock_read=self.client_configuration.timeout_seconds
            )
        )
